...
namespace IdentityServer4Demo
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.ConnectionString = this.Configuration.GetSection("MongoDB:ConnectionString").Value;
                options.Database = this.Configuration.GetSection("MongoDB:Database").Value;
            });

            services.AddMongoDBIdentity<ApplicationUser, ApplicationRole>();
